...
def plot_final(df, N, A):
    ...
    plt.show()
    plt.savefig("optimal_rss_text.png")
...
def optimize_mc(N,A0):  
    ...
    csv_name = 'rutherford_mc_fast_opt ' + str(N*5/2) +str(A_best)+ '.csv'
    np.savetxt(csv_name, data_best.transpose(), delimiter=',',fmt='%.10e')
    
    print("Saved " + 'final ' + str(N*5/2) +str(A_best)+ '.csv')
